...
activities = {
    ...
    "Music Band": {
        ...
        "schedule": "Thursdays and Fridays, 4:30 PM - 5:30 PM",
        "max_participants": 25,
...
def signup_for_activity(activity_name: str, email: str, age: int):
    ...
    return {"message": f"Signed up {email} (age {age}) for {activity_name}"}
